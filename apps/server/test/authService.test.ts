...
describe("AuthService", () => {
  ...
  it("backfills votes for changes that were ingested before the founder existed", () => {
    ...
    s.upsertChange({ id: "c1", repo: "r", branch: "main", filePath: "memory-bank/a.md",
      ...
      committedAt: "t", summary: "s", oldMd: null, newMd: "n", previousPath: null, baselineCommitId: null, previousNewMd: null, commitCount: 1,
  ...
  it("invites then redeems a new guardian and backfills votes", () => {
    ...
    s.upsertChange({ id: "c1", repo: "r", branch: "main", filePath: "memory-bank/a.md",
      ...
      previousPath: null, baselineCommitId: null, previousNewMd: null, commitCount: 1, cycleId: s.getOpenCycle()!.id, firstSeenAt: "t" });
