...
export function MeetingTab({ meeting, guardians, onOpen }:
  ...
  if (changes.length === 0) return (
    <EmptyState paths={ICON_CIRCLE_CHECK} title="Alles bestätigt">
      Jede Änderung an der Memory-Bank ist von allen Hütern akzeptiert.
  ...
  const parts = [
    ...
    counts.offen > 0 && `${counts.offen} ausstehend`,
