...
const components: Components = {
  h1: p => <h1 className="text-[18px] font-semibold text-ctp-text mt-3 mb-1.5">{p.children}</h1>,
  h2: p => <h2 className="text-[16px] font-semibold text-ctp-text mt-3 mb-1.5">{p.children}</h2>,
  h3: p => <h3 className="text-[15px] font-semibold text-ctp-text mt-2.5 mb-1">{p.children}</h3>,
  h4: p => <h4 className="text-[14px] font-semibold text-ctp-subtext1 mt-2 mb-1">{p.children}</h4>,
  h5: p => <h5 className="text-[13px] font-semibold text-ctp-subtext1 mt-2 mb-1">{p.children}</h5>,
  h6: p => <h6 className="text-[13px] font-semibold text-ctp-subtext0 mt-2 mb-1">{p.children}</h6>,
  p: p => <p className="text-[14px] text-ctp-subtext1 leading-relaxed my-1.5">{p.children}</p>,
  ul: p => <ul className="list-disc pl-5 my-1.5 text-[14px] text-ctp-subtext1">{p.children}</ul>,
  ol: p => <ol className="list-decimal pl-5 my-1.5 text-[14px] text-ctp-subtext1">{p.children}</ol>,
  ...
  pre: p => <pre className="bg-ctp-mantle border border-ctp-surface0 rounded-lg p-3 overflow-x-auto my-2 text-[13px] leading-relaxed">{p.children}</pre>,
  code: p => {
    ...
    return isBlock
      ...
      : <code className="bg-ctp-surface0 text-ctp-subtext1 rounded px-1 text-[13px] font-mono">{p.children}</code>;
  },
  table: p => <div className="overflow-x-auto my-2"><table className="border-collapse text-[14px]">{p.children}</table></div>,
